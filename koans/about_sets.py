...
class AboutSets(Koan):
    ...
    def test_dictionaries_and_sets_use_same_curly_braces(self):
        ...
        self.assertEqual(set([1,2]).__class__, {1, 2, 3}.__class__)
        self.assertEqual(dict(call = 'hello', response = 'there').__class__, {'one': 1, 'two': 2}.__class__)

        self.assertEqual(dict(big = 'true', small = 'false').__class__, {}.__class__)

    # def test_creating_sets_using_strings(self):
    #     self.assertEqual(set(str('1' + '2' + '3' + '4' + '5')), {'12345'})
    #     self.assertEqual({'12345'}, set(str('1' + '2' + '3' + '4' + '5')))
